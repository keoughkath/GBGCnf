...
#======================================================================
        ...
        mod.b            = init.mod
        mod.b$selection  = 0
        #mod.b            = add.ls.mod(mod.b,"hg38",sep=b.range,selection=0,const.params="sel")
        mod.b            = add.ls.mod(mod.b,"hg38",sep=b.bhg.range, bgc=0)
	...
	#- selection model
        ...
        mod.s            = init.mod
        mod.s$selection  = 0
        mod.s            = add.ls.mod(mod.s,"hg38",sep=a.shg.range)
	...
	#- selection and gBGC
        ...
        mod.sb            = init.mod
        mod.sb$selection  = 0
        mod.sb            = add.ls.mod(mod.sb,"hg38",sep=ab.sbhg.range)
