...
maskCpG <- function(ali,names=c("Homo_sapiens","Pan_troglodytes","Macaca_mulatta")){
#============================================================
...
countSub <- function(ali,names=c("Homo_sapiens","Pan_troglodytes","Macaca_mulatta")){
#=============================================================
...
getAnc <- function(ali,names=c("Homo_sapiens","Pan_troglodytes","Macaca_mulatta")){
#===========================================================
...
#=========================
        anc     = getAnc(ali)
        hg      = toupper(ali[[1]][which(ali$names=="Homo_sapiens")])
        hg      = strsplit(hg, split="")[[1]]
        pt      = toupper(ali[[1]][which(ali$names=="Pan_troglodytes")])
